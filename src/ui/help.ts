...
export function openHelp(): void {
  ...
  body.append(
    ...
    section('Playing', [
      ...
      'Keyboard: arrows move, 1–9 toggle, Shift and a digit, or a quick double press of it, forces, Delete or Backspace clears, M fills the marks, Z undoes, Y redoes. When Check or Hint is set to need a hold, the keyboard uses Shift with C or H — Clear is never guarded on a keyboard, where a key press is deliberate and rubbing a cell out undoes anyway.',
    ]),
    section('The table', [
